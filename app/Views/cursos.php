...
<body>
    ...
    <div class="container-fluid">
                    ...
                    <div class="col-sm-2">
                        <div class="card m-2" style="width: 18rem;">
                            ...
                            <div class="card-body">
                                ...
                                <a href="<?php echo base_url('../moodle/course/view.php?id=' . $curso['id']) ?>" class="btn btn-primary">Selecionar</a>
                            </div>
                        </div>
                    </div>
                <?php endforeach;
        ...
        <center><a href="<?php echo base_url('../categorias') ?>" class="btn btn-outline-info m-2">Voltar</a></center>
